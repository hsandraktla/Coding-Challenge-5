...
const calculatePoints = purchaseAmount => purchaseAmount / 10; //Return 1 point per $10 spent
//Log the result.
let pointsEarned = calculatePoints(1000);
console.log(`You have earned ${pointsEarned} loyalty points from this purchase.`);
